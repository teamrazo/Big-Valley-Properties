...
export const agents: Agent[] = [
  {
    ...
    bio: 'Retta Treanor is the founder and Broker/Owner of Big Valley Properties, the leading brokerage serving Trinity and Shasta Counties. With deep roots in Northern California and a passion for helping families find their dream homes, Retta brings unmatched local expertise and dedication to every transaction. Her philosophy is simple: Educate, Negotiate, Communicate. Whether you\'re buying your first mountain cabin or selling a multi-generational ranch, Retta\'s personalized approach ensures a seamless experience from start to finish.',
    ...
    achievements: ['#1 Brokerage Serving Trinity & Shasta Counties', '20+ Years of Excellence', '500+ Successful Transactions'],
    yearsExperience: 20,
    testimonial: {
  ...
  },
  {
    ...
    name: 'Trish Harris',
    title: 'REALTOR®',
    licenseNumber: 'CA DRE #02225871',
    phone: '(530) 722-8787',
    email: 'TrinityTrishProperties@gmail.com',
    photo: '/images/agents/trish-harris-real.jpg',
    bio: 'Trish Harris is a lifelong Northern California resident with deep roots in both Shasta County and Trinity County. A seasoned entrepreneur, she brings over 20 years of business ownership and community leadership to her real estate career. Prior to real estate, Trish built and operated a music school, theater academy, and nonprofit serving children with autism in Redding, and spent 15 years as a music director and performer at the historic Cascade Theatre.\n\nIn 2023, she relocated to Weaverville, where she purchased a downtown commercial building and opened a boutique retail business. She has served as President - and now Vice President - of the Weaverville Chamber of Commerce, supporting local economic growth.\n\nTrish\'s approach to real estate goes beyond transactions - it\'s about helping clients step into a way of life. From downtown storefronts to mountain retreats and homestead-ready land, she connects clients to properties aligned with their vision and values, blending strategy with lifestyle.\n\nProudly representing Big Valley Properties, Trish serves Trinity and Shasta Counties with local expertise and a genuine love for the communities she calls home.',
    specialties: ['Residential Sales', 'Vacation Properties', 'Property Management', 'Buyer Representation'],
    counties: ['Trinity', 'Shasta'],
    social: {},
    featured: true,
    certifications: ['REALTOR®'],
    yearsExperience: 3,
    testimonial: {
      text: 'Trish was wonderful to work with. She listened to exactly what we wanted and helped us find the perfect property in the mountains. Her knowledge and warmth made the whole experience enjoyable.',
