...
export const agents: Agent[] = [
  ...
  },
  {
    ...
    phone: '(530) 722-8787',
    email: 'trishbnb@gmail.com',
    photo: '/images/agents/trish-harris-real.jpg',
    bio: 'Trish Harris is a dedicated REALTOR® with Big Valley Properties, bringing warmth, professionalism, and a deep love for Northern California to every client interaction. With a background in hospitality and property management, Trish understands what makes a house truly feel like home. Her attention to detail and genuine commitment to her clients make her a valued member of the Big Valley Properties team. Whether you are searching for a cozy mountain retreat, a family home, or an investment property, Trish is ready to guide you through every step of the process with care and expertise.',
